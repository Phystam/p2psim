...
tree->Branch("P1LL","TLorentzVector",&P1LL);
tree->Branch("P2LL","TLorentzVector",&P2LL);
tree->Branch("PALL","TLorentzVector",&PALL);
tree->Branch("MissingMass","TLorentzVector",&MissingMass);
tree->Branch("PBLL","TLorentzVector",&PBLL);
tree->Branch("ReconstructedEx",&ReconstructedEx);
...
//Center-off-mass varaibles of two nucleons
